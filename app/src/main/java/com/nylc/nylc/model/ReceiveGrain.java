...
public class ReceiveGrain implements Parcelable {
    ...
    public static final Parcelable.Creator<ReceiveGrain> CREATOR = new Parcelable.Creator<ReceiveGrain>() {
        @Override
        public ReceiveGrain createFromParcel(Parcel source) {
            return new ReceiveGrain(source);
        }

        @Override
        public ReceiveGrain[] newArray(int size) {
            return new ReceiveGrain[size];
        }
    };
}
