...
/**
 * 验证手机号码、电话号码（包括最新的电信、联通和移动号码）
 * @className: PhoneFormatCheckUtils
 * @author sangyue
 * @date Jun 27, 2017 9:55:39 PM
 * @version V1.0 http://blog.csdn.net/linbilin_/article/details/49796617
 */
public class PhoneFormatCheckUtils {
    ...
    public static void main(String[] args) {
		System.out.println(PhoneFormatCheckUtils.isPhone("15966755821"));
	}
}
